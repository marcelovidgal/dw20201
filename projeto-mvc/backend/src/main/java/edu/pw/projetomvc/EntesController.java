...
@RestController
@RequestMapping(path="/entes")
public class EntesController {

	private EntesRepository entesRepository;

	public EntesController(EntesRepository entesRepository) {
		//super();
		this.entesRepository = entesRepository;
	}
	...
	@GetMapping
	public List<Entes> listagem() {
		List<Entes> entes = new ArrayList<>();
		//entes = entesRepository.findAll();
		return entesRepository.findAll();
	}
