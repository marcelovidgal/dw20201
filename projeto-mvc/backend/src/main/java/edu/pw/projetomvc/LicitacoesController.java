...
public class LicitacoesController {
	...
	public LicitacoesController(LicitacoesRepository licitacoesRepository) {
		//super();
		this.licitacoesRepository = licitacoesRepository;
	}
	...
	@GetMapping
	public List<Licitacoes> listagem() {
		List<Licitacoes> licitacoes = new ArrayList<>();
		//entes = entesRepository.findAll();
