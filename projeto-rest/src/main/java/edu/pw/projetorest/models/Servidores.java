...
public class Servidores {
	...
	public Servidores(Integer servidorId, String nome, String cargo, String cnpj, String cpf, Integer mes, Integer ano,
			Double valorBruto, NaturezaCargo naturezaCargoId, Unidade unidadeId, Integer acumulos,
			Double valorBrutoTotal, String nomeUnidadeLotacao) {
	...
	/*
	 * @Override public String toString() { return "{" + "id=" + id + ", enteId='" +
	 * enteId + "\'" + ", nome='" + nome + "\'" + ", orgaos='" + orgaos + "\'" +
	 * "}"; }
	 */
}