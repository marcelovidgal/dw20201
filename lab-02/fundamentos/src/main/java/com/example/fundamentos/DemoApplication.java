...
import com.example.fundamentos.repository.AplicacaoRepository;
...
public class DemoApplication {
	...
	public CommandLineRunner demo(AplicacaoRepository repository) {
		return (args) -> {
			...
			repository.save(new Aplicacao("notificacoes","jose.mateus","aplicacao para enviar alertas e notificacoes aos usuarios"));
